...
const Curiosidades = () => {
  const facts = [
    {
      ...
      description: "I spend at least 2 hours daily learning new technologies, reading research papers, and exploring emerging trends in AI and data science.",
      color: "from-yellow-500/20 to-yellow-500/5"
    },
    {
      icon: BookOpen,
      title: "Tech Writer",
      description: "I enjoy writing technical articles and documentation. Sharing knowledge helps me solidify my understanding and contributes to the community.",
  ...
  const funFacts = [
    "I can solve complex data problems while listening to lo-fi beats",
    "My first line of code was in Python, and I've never looked back",
    "I've attended 15+ tech conferences and hackathons in the last 3 years",
    "I'm fascinated by the intersection of art and technology",
    "I maintain a personal knowledge base with 500+ technical notes",
    "I believe that great code is like great poetry—elegant and purposeful"
  ];
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section id="curiosidades" className="pt-32 pb-20 px-4">
        <div className="container max-w-4xl mx-auto">
          ...
          >
            ...
            <p className="text-lg text-muted-foreground mb-12 leading-relaxed">
              ...
              but definitely shape who I am as a technologist and person.
            </p>

            {/* Main Facts */}
            <div className="mb-16">
              <h2 className="text-3xl font-bold mb-8">What Makes Me Tick</h2>
            ...
            {/* Fun Facts */}
            <div>
              <h2 className="text-3xl font-bold mb-8">Fun Facts About Me</h2>
            ...
            >
              ...
              <p className="text-muted-foreground mb-6">
                Ask RodrigoAI anything about my journey, interests, or projects. I'm always happy to chat!
              </p>
              <a
                href="/#"
