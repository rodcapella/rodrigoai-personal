	...
	return (
		<div className="min-h-screen bg-background">
			<Helmet>
				...
				<meta
					property="og:title"
					content="Why Me? | Rodrigo Póvoa – Tech Leader & AI Entrepreneur"
				/>
				<meta
				...
				<meta
					property="og:image"
					content="https://www.rpovoadata.tech/rodrigo_why_me.png"
				/>
			...
			<script
				...
				dangerouslySetInnerHTML={{
					__html: JSON.stringify({
						...
						description:
							'Enterprise Data Architect and Analytics Platform Leader specializing in Azure, Databricks and modern Lakehouse architectures.',
						sameAs: [
			...
			<Suspense fallback={null}>
				<main className="pt-36 pb-24">
					...
					>
						...
						>
							<h3 className="text-2xl font-bold mb-2">Architecture</h3>

							<p className="text-xl font-semibold mb-2">
								Data Platforms → AI-Native Systems
							</p>
							<p className="text-muted-foreground">
							...
							<p className="text-muted-foreground">
								Clear ownership, accountability, and trust
							</p>
							...
							<p className="text-muted-foreground">
								Technology multiplies human capability and creativity
							</p>
						</motion.div>
					</PageSection>
					...
					>
						<PageGrid cols={3}>
							<div>
								...
								<p className="text-muted-foreground">
									I design scalable architectures that support governance,
									analytics, and AI workloads from the same data foundation.
								</p>
							</div>
							...
							<div>
								...
								<p className="text-muted-foreground">
									Sapiente.AI serves as a laboratory for new architectures and
									experimental systems that anticipate the next generation of
									data platforms.
								</p>
							</div>
							...
							<div>
								...
								<p className="text-muted-foreground">
									I build teams, define technical standards, and structure
									platforms that allow data organizations to grow sustainably.
								</p>
							</div>
							...
							<div>
								...
								<p className="text-muted-foreground">
									Reliable pipelines, consistent metrics, and strong governance
									frameworks restore confidence in organizational data.
								</p>
							</div>
							...
							<div>
								...
								<p className="text-muted-foreground">
									I help organizations move from operational reporting to
									treating data as products with ownership, quality standards,
							...
							<div>
								...
								<p className="text-xl font-semibold mb-2">AI in Production</p>
								<p className="text-muted-foreground">
									Aligning data engineering, governance, and platform
									architecture so AI initiatives can move beyond prototypes into
									production systems.
								</p>
							</div>
						</PageGrid>
