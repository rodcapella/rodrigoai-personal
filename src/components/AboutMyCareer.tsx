...
const AboutMyCareer = () => {
  const funFacts = [
    ...
    "I believe that great data architecture is like great engineering: elegant, scalable, and purposeful",
    "Committed to establishing data governance best practices and compliance standards",
    "Skilled in designing analytics products, dashboards, and reports that turn data into actionable insights",
